!(function (e) {
  ...
  e(document).ready(function () {
    e(".course_slider_top").slick({
      ...
      e(".course_category_slider").slick({
        centerMode: !1,
        autoplay: !1,
        focusOnSelect: !0,
        slidesToShow: 3,
      ...
      e(".instructor_teacher_page_course_slide").slick({
        autoplay: !1,
        slidesToShow: 3,
        slidesToScroll: 1,
        dots: !1,
      ...
      e("#header_sticky_ticker").bwlJqueryNewsTicker({
        interval: 3e3,
        animation: "fadeleft",
        title: "Notice",
        theme: "purple",
    ...
    e(".banner__animation--slide").slick({
      autoplay: !0,
      slidesToShow: 1,
      autoplaySpeed: 2e3,
      arrows: !1,
    ...
    e(".add__popup--venubox").venobox(),
    e(".select__course").select2(),
    e(".job__getters--card--slider").slick({
      slidesToShow: 3,
      slidesToScroll: 1,
      arrows: !0,
      dots: !1,
    ...
    e(".aboutus__testemonial--slider").slick({
      infinite: !0,
      slidesToShow: 1,
      slidesToScroll: 1,
      arrows: !0,
    ...
    e(".testemonial__videopopup").venobox({
      bgcolor: "#000",
      border: "0",
      autoplay: !0,
      showCloseButton: !0,
...
(window.onscroll = function () {
  stickyHeader.classList.contains("rbt-sticky")
    ? (logoImg.style.height = "80px")
    : logoImg.setAttribute("src", "assets/images/logo.webp");
}),
  (window.onscroll = function () {
    let e = document.querySelector(".rbt-header-wrapper");
    window.pageYOffset >= 200
      ? e.classList.add("rbt-sticky")
      : e.classList.remove("rbt-sticky");
  });
let mobileMenuBtn = document.querySelector(".hamberger-button"),
  popupMobileMenuItem = document.querySelector(".popup-mobile-menu");
mobileMenuBtn.addEventListener("click", function () {
  popupMobileMenuItem.classList.contains("active")
